...
public class MainWindowFragment extends Fragment {
    ...
    private void createBlankScreen() {
        ...
        List<nikitin.weatherapp.com.weatherapptest3.model.Weather> weathers = new ArrayList<>();
        weathers.add(new nikitin.weatherapp.com.weatherapptest3.model.Weather(0, "unknown location", null, null));
